...
public class DriverHomeActivity extends AppCompatActivity {
    ...
    private boolean showDialogUpload() {
        AtomicReference<AlertDialog.Builder> builder = new AtomicReference<> ( new AlertDialog.Builder ( DriverHomeActivity.this ) );
        builder.get ( ).setTitle ("Change avatar")
                .setMessage ( "Do you really want to change avatar?" )
                .setNegativeButton ( "CANCEL", (DialogInterface , i) -> { android.content.DialogInterface.dismiss ( )
                ...
                .setCancelable ( false );
        AlertDialog dialog = builder.get ( ).create ();
        dialog.setOnShowListener ( DialogInterface -> {
            Dialog.getButton(AlertDialog.BUTTON_POSITIVE )
                    .setTextColor(getResources ().getColor ( android.R.color.holo_red_dark ));
            Dialog.getButton(AlertDialog.BUTTON_NEGATIVE )
                    .setTextColor(getResources ().getColor ( android.R.color.colorAccent));
        };
    ...
    private void init() {
        ...
        navigationView.setNavigationItemSelectedListener (item ->  {
                    ...
                    {
                        {
                            ...
                            dialog.setOnShowListener ( DialogInterface -> {
                                Dialog.getButton(AlertDialog.BUTTON_POSITIVE )
                                        .setTextColor(getResources ().getColor (DriverHomeActivity.this,android.R.color.holo_red_dark ));
                                Dialog.getButton(AlertDialog.BUTTON_NEGATIVE )
                                        .setTextColor(getResources ().getColor (DriverHomeActivity.this,android.R.color.colorAccent));
                            };
                ...
                txt_name.setText( (CharSequence) Common.buildWelcomeMessage() );
